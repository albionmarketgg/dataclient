...
1. Download the latest `AlbionMarketDataClient-Setup.exe` from the
   [Releases](https://github.com/albionmarketgg/dataclient/releases) page.
...
The module path is `github.com/albionmarketgg/dataclient`. The frontend lives in `frontend/`
